...
MARKETS = [
    ...
    MarketMetadata(
        ...
        True,
        True,
        "Passing Yards V1 historical-test market using projected pass attempts and yards per attempt.",
    ),
    MarketMetadata(
        "completions",
        "Completions",
        ...
        True,
        True,
        "Completions V1 historical-test market using projected pass attempts and completion rate.",
    ),
    MarketMetadata(
        "pass_attempts",
        "Pass Attempts",
        ...
        True,
        True,
        "Pass Attempts V1 historical-test market using team pass attempts and QB attempt share.",
    ),
    MarketMetadata(
        "carries",
        "Carries",
        ...
        True,
        True,
        "Carries V1 historical-test market using team rush attempts and player rush-attempt share.",
    ),
    MarketMetadata(
        "targets",
        "Targets",
