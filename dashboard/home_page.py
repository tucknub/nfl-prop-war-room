...
from research_ui import page_intro, render_change_rows, section, source_footer, table, team_rail, yard_rule
...
def render_home() -> None:
    ...
    if changes.empty:
        ...
        inspect = inspect.rename(
            columns={
                "player_name": "Player",
                "team": "Team",
                "role_family_label": "Role family",
                "raw_opportunities": "Opportunities",
                "team_denominator": "Denominator",
                "baseline_games": "Games in baseline",
