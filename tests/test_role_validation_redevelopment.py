...
def test_loader_allows_explicit_folds_through_2024_but_rejects_2025_request(tmp_path):
    ...
    fold4 = load_canonical_seasons(str(path), seasons=[2024])
    assert fold4["season"].tolist() == [2024]
    with pytest.raises(ValueError, match="2018.*2024"):
        load_canonical_seasons(str(path), seasons=[2025])
