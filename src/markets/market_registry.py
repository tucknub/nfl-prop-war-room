...
MARKETS = [
    ...
    MarketMetadata(
        ...
        True,
        True,
        "Planned next because it can build from receiving opportunity, catch-rate, and efficiency extensions.",
    ),
    MarketMetadata(
        "rushing_yards",
        "Rushing Yards",
        ...
        True,
        True,
        "Planned volume-efficiency market for rush attempts and yards per carry.",
    ),
    MarketMetadata(
        "passing_yards",
        "Passing Yards",
