...
BASE = "009703cfaead7beaaef6ddf53202557b87bde744"
...
ALLOWED = [
    ...
    "scripts/run_weekly_role_report_replay.py",
    "scripts/validate_weekly_role_report.py",
    "scripts/validate_weekly_role_report_scope.py",
