...
SPECS = [
    ...
    MetricSpec("recent_receptions_form", "recent_form", "Receiving Signal Board", "", "", "No", "No", "planned", "unknown", "unknown", "NEEDS SOURCE", "Do not create unless real rolling recent-form columns are exposed."),
    ...
    MetricSpec("opponent_allowed_by_position", "matchup", "By-Game Matchup Board", "", "", "No", "No", "planned", "unknown", "unknown", "PLANNED_SOURCE", "Opponent defensive context is not sourced yet."),
    ...
    MetricSpec("spread_total_game_script", "game_script", "Slate Overview", "", "", "No", "No", "planned", "unknown", "unknown", "NEEDS SOURCE", "No live spread/total source loaded."),
