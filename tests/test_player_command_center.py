...
def test_player_command_live_context_is_parallel_and_bounded() -> None:
    from pathlib import Path
    ...
    assert "client.fetch_normalized_leagues(" in owner_source
    assert "max_workers=3" in owner_source
    assert (
